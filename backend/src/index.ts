...
import projectFileRoutes from './routes/archivoProyecto.routes';
import chatRoutes from './routes/chat.routes';
import historyRoutes from './routes/historial.routes';
import calendarRoutes from './routes/calendario.routes';
import accountRoutes from './routes/cuenta.routes';
import activityRoutes from './routes/actividad.routes';
import verificationRoutes from './routes/verificacion.routes';
